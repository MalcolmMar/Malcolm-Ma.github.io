...
var View = /** @class */ (function (_super) {
    ...
    View.prototype.initHiddenDays = function () {
        ...
        var isHiddenDayHash = []; // is the day-of-week hidden? (hash with day-of-week-courses -> bool)
        var dayCnt = 0;
        var i;
    ...
    // `day` is a day-of-week courses (0-6), or a Moment
...
var CoordCache = /** @class */ (function () {
    ...
    // Given a left offset (from document left), returns the courses of the el that it horizontally intersects.
    ...
    // Given a top offset (from document top), returns the courses of the el that it vertically intersects.
    // If no intersection is made, returns undefined.
    ...
    // Gets the left offset (from document left) of the element at the given courses
    CoordCache.prototype.getLeftOffset = function (leftIndex) {
        this.ensureBuilt();
        return this.lefts[leftIndex];
    };
    // Gets the left position (from offsetParent left) of the element at the given courses
    CoordCache.prototype.getLeftPosition = function (leftIndex) {
        this.ensureBuilt();
        return this.lefts[leftIndex] - this.origin.left;
    };
    // Gets the right offset (from document left) of the element at the given courses.
    // This value is NOT relative to the document's right edge, like the CSS concept of "right" would be.
    CoordCache.prototype.getRightOffset = function (leftIndex) {
        this.ensureBuilt();
        return this.rights[leftIndex];
    };
    // Gets the right position (from offsetParent left) of the element at the given courses.
    // This value is NOT relative to the offsetParent's right edge, like the CSS concept of "right" would be.
    CoordCache.prototype.getRightPosition = function (leftIndex) {
        this.ensureBuilt();
        return this.rights[leftIndex] - this.origin.left;
    };
    // Gets the width of the element at the given courses
    CoordCache.prototype.getWidth = function (leftIndex) {
        this.ensureBuilt();
        return this.rights[leftIndex] - this.lefts[leftIndex];
    };
    // Gets the top offset (from document top) of the element at the given courses
    ...
    // Gets the bottom offset (from the document top) of the element at the given courses.
    // This value is NOT relative to the offsetParent's bottom edge, like the CSS concept of "bottom" would be.
    CoordCache.prototype.getBottomOffset = function (topIndex) {
        this.ensureBuilt();
        return this.bottoms[topIndex];
    };
    // Gets the bottom position (from the offsetParent top) of the element at the given courses.
    // This value is NOT relative to the offsetParent's bottom edge, like the CSS concept of "bottom" would be.
    CoordCache.prototype.getBottomPosition = function (topIndex) {
        this.ensureBuilt();
        return this.bottoms[topIndex] - this.origin.top;
    };
    // Gets the height of the element at the given courses
...
var DayTableMixin = /** @class */ (function (_super) {
    ...
    // Given a date, returns its chronolocial cell-courses from the first cell of the grid.
    ...
    DayTableMixin.prototype.sliceRangeByRow = function (unzonedRange) {
        ...
        var rangeFirst = this.getDateDayIndex(normalRange.start); // inclusive first courses
        var rangeLast = this.getDateDayIndex(normalRange.end.clone().subtract(1, 'days')); // inclusive last courses
        var segs = [];
        var row;
        var rowFirst;
        var rowLast; // inclusive day-courses range for current row
        var segFirst;
        var segLast; // inclusive day-courses range for segment
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.computeTimeTop = function (time) {
        ...
        // an integer courses of the furthest whole slat
    ...
    TimeGrid.prototype.getHitFootprint = function (hit) {
        ...
        var time = this.computeSnapTime(hit.snap); // pass in the snap-courses
        var end;
        start.time(time);
...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    TimeGridEventRenderer.prototype.updateFgSegCoords = function (segs) {
        ...
        this.computeFgSegHorizontals(segs); // compute horizontal coordinates, z-courses's, and reorder the array
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.buildSegLevels = function (segs) {
        ...
        for (i = 0; i < segs.length; i++) {
            ...
            // `j` now holds the desired subrow courses
            seg.level = j;
